...
public record BpnFeatureStarted(Guid ContainerId, Guid FeatureId, long FeatureRevision, DateTimeOffset StarTime, Guid CorrelationId) : IEngineEvents;
public record BpnFeatureError(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, ErrorEvent Exception) : IEngineEvents;
public record BpnFeatureCompleted(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, DateTimeOffset EndTime, double DurationMs) : IEngineEvents;
public record BpnTaskInitialized(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, Guid TaskId, string Input) : IEngineEvents;
public record BpnTaskFailed(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, Guid TaskId, ErrorEvent Exception, double ExecutionTimeMs) : IEngineEvents;
public record BpnFailedTaskReInitialized(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, string NewInput, double ExecutionTimeMs) : IEngineEvents;
public record BpnTaskSucceeded(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, Guid TaskId, double ExecutionTimeMs) : IEngineEvents;
public record BpnTransitionUsed(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, Guid FromBpn, Guid ToBpn) : IEngineEvents;
public record BpnTransitionSkipped(Guid CorrelationId, Guid ContainerId, Guid FeatureId, long FeatureRevision, Guid FromBpn, Guid ToBpn) : IEngineEvents;
