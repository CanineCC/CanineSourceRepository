...
public class C4ContainerDiagram : ContainerDiagram
{
    ...
    protected override IEnumerable<Structure> Structures
    {
        get
        {
            ...
            structures.Add(Person.None | Boundary.External | ("User", "TODO-user",
                "Todo-user description."));
            foreach (var container in _containers)
            {
                containers.Add(Container.None | (ContainerType.WebApplication, container.Name.ToPascalCase(), "WebApp", "C#, WebApi", container.Description));
            }
