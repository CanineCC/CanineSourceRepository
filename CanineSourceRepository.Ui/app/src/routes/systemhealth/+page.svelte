										...
										{#if container && container.features}
											{#each container.features as feature, featureindex}
												{#await getHighestVersion(feature.revisions) then highestVersionFeature}
													<tr>
														<td class="title-column">
															<button title="Feature" aria-label="Feature"
														...
														<td class="version-column">{'v' + highestVersionFeature.revision}</td>
														<td class="number-column">{highestVersionFeature.stats.invocationCount}</td>
														<td class="number-column">{highestVersionFeature.stats.invocationErrorCount}</td>
														<td class="number-column">{highestVersionFeature.stats.invocationCompletedCount}</td>
														<td class="number-column">{highestVersionFeature.stats.invocationsInProgressCount}</td>
														<td class="number-column">
														...
														<td class="tooltip date-column" data-tooltip={highestVersionFeature.stats.lastUsed}>
															{$currentTime
																? formatDate(
														...
														<td class="tooltip date-column" data-tooltip={highestVersionFeature.stats.published}>
															{$currentTime  ? formatDate(highestVersionFeature.stats.published, $currentTime) : '-'}
														</td>
													</tr>
												{/await}
																...
																<table>
																	...
																	{#each feature.revisions as version}
																			<tr>
																				...
																				<td class="version-column">{'v' + version.revision}</td>
																				...
																				<td class="number-column"><FeatureDuration duration={version.stats.maxDurationMs}   durationClasses={durationClasses}/></td>
																				<td class="number-column"><FeatureDuration duration={version.stats.avgDurationMs}   durationClasses={durationClasses}/></td>
																				<td class="number-column"><FeatureDuration duration={version.stats.minDurationMs}  durationClasses={durationClasses} /></td>
																				...
																				>
																					{$currentTime ? formatDate(version.stats.published, $currentTime) : '-'}
																				</td>
																			</tr>
																	{/each}
																	</tbody>
																</table>
																<p style="color: red">TODO: Withdraw a revision = mark it as obsolete (pr a given date), also mark for deletion pr another given date (take TOS on system into account) </p>
															</div>
														</td>
													</tr>
												{/if}
